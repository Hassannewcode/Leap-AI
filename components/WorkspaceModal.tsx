...
const WorkspaceModal: React.FC<WorkspaceModalProps> = ({ workspaces, onSelect, onCreate, onDelete, onUpload, deleteModal }) => {
    ...
    <>
        <div className="w-screen h-screen bg-black flex flex-col items-center justify-start p-8 text-center overflow-y-auto">
            <div className="flex items-center gap-4 mb-4 mt-8 md:mt-16">
                ...
                <h1 className="text-5xl font-bold text-gray-100 tracking-tighter">Leap AI</h1>
            </div>
            ...
            <div className="w-full max-w-2xl space-y-6">
                ...
                <div className="pt-2">
                    ...
                    <button
                        ...
                        className="group bg-[#121212] p-6 w-full rounded-lg border border-dashed border-gray-700 hover:border-blue-500/80 hover:bg-blue-900/10 transition-all duration-300 flex items-center justify-center gap-4"
                    >
                        <UploadCloudIcon className="w-8 h-8 text-gray-500 group-hover:text-blue-400 transition-colors" />
                        <h2 className="text-xl font-semibold text-gray-300 group-hover:text-white">Upload Project (.zip)</h2>
                    </button>
                </div>
